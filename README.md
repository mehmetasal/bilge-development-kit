...
```
22 Agent | 56 Core Skill | 37 Extra Skill | 16 Workflow | 4 Hook | 5 Rule | 3 Context
```
...
- [Slash Komutları (19)](#slash-komutları-19)
...
Chat'e `/komut` yazarak tetiklenen yapılandırılmış iş akışları. 16 workflow komutu + 3 skill komutu.
