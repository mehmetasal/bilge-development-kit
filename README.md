...
```
22 Agent | 56 Core Skill | 37 Extra Skill | 17 Workflow | 4 Hook | 5 Rule | 3 Context
```
...
- [Slash Komutları (20)](#slash-komutları-20)
...
Chat'e `/komut` yazarak tetiklenen yapılandırılmış iş akışları. 17 workflow komutu + 3 skill komutu.
